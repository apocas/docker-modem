...
var defaultOpts = function() {
  ...
  if (!process.env.DOCKER_HOST) {
    ...
    } else if (process.env.DOCKER_CERT_PFX) {
      opts.pfx = fs.readFileSync(path.join(process.env.DOCKER_CERT_PFX));
      opts.passphrase = process.env.DOCKER_CERT_PFX_PASSPHRASE;
    }
  }
...
var Modem = function(opts) {
  ...
  if ((this.key && this.cert && this.ca) || this.pfx) {
    this.protocol = 'https';
  }
